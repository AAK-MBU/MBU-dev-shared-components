...
def sharepoint_api():
    """
    Authenticate with SharePoint and return a Sharepoint instance.
    """
...
def test_list_files_from_sharepoint_folder(sharepoint_api):
...
def test_append_row_to_excel(sharepoint_api):
...
def test_format_and_sort_excel_file(sharepoint_api):
    file_name = "Test_Append_Rows.xlsx"
    sheet_name = "Upload logs"
    ...
    top_before = all_rows[1]
    bottom_before = all_rows[-1]
